...
namespace ProjectEta.Pieces // 기물 이동 규칙 데이터를 모아두는 네임스페이스
{
    ...
    {
        [SerializeField] private MovementRuleKind _kind; // Step·Slide·Leap·Conditional 중 사용할 규칙 종류
        [SerializeField] private Vector2Int[] _vectors = Array.Empty<Vector2Int>(); // 방향 또는 도약 상대 좌표 목록
        [SerializeField] private int _maxSteps = 1; // Step·Slide에서 한 방향으로 진행할 최대 칸 수
        ...
        public int MaxSteps => _maxSteps; // 외부 팩토리가 읽는 최대 진행 칸 수
