...
namespace ProjectEta.Steam
{
    public sealed class SteamOverlayDebugShortcut : MonoBehaviour
    {
        private void Update()
        {
            ...
            bool opened = SteamPlatform.OpenOverlay(SteamOverlayPage.Friends); // 친구 Overlay 테스트 호출
            Debug.Log($"77일차 Steam Overlay F8 테스트: Opened={opened} / Backend={SteamPlatform.BackendName} / Available={SteamPlatform.IsOverlayAvailable}"); // 테스트 결과 기록
        }
    }
}
#endif
